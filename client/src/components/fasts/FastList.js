...
import {
  Button, Card, Grid, Header, Icon, Segment, Label,
          ...
          <Grid.Row verticalAlign="middle" style={{ justifyContent: 'flex-start' }}>
            <Grid.Column width="11">
              <Segment vertical style={{ overflow: 'auto', maxHeight: '100vh' }}>
                ...
                <Header as="h3" style={{ display: 'inline-block', marginLeft: '5px' }}>
                  Logged Fasts
                  <Label circular color="olive">{this.state.fasts.length}</Label>
                </Header>
            ...
            <Grid.Column width="3" style={{ paddingRight: 0, paddingLeft: 0 }}>
              <Segment
                ...
                raised
                style={{
                  display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%', overflow: 'auto', height: '100vh',
                }}
                id="sidebar"
              >
                <InfoPanel
                  fast={this.state.selected}
